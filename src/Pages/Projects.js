            ...
            <div className="projcontainer">
                ...
                <div className="projimage">
                    <img src={ Valen } alt="Portfolio" />
                        ...
                        <p>Created a cute website gimmick to ask your potential valentine out!! Its functions are all front-end making use of the useState component in React. Something to put a smile on someones face!</p>
                        <div className="linkbox">
